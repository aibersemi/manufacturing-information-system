...
type SheetSectionProps = Pick<React.ComponentProps<"div">, "children" | "className" | "id">;

const SheetHeader = ({ children, className, id }: SheetSectionProps) => (
...
const SheetFooter = ({ children, className, id }: SheetSectionProps) => (
	<div
		id={id}
